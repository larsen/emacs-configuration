;;; modus-operandi-larsen-theme.el --- Elegant, highly legible theme with a white background -*- lexical-binding:t -*-
...
;;;###theme-autoload
  (deftheme modus-operandi-larsen
...
7:1 (WCAG AAA standard)."
  ...
  (defconst modus-operandi-larsen-palette
    '(
;;; Basic values
...
;;;; Date mappings
      ...
      (date-scheduled-subtle yellow-warmer)
      (date-weekday cyan)
...
;;;; Heading mappings
    ...
    "The entire palette of the `modus-operandi-larsen' theme.
...
exists in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom modus-operandi-larsen-palette-user nil
    "Like the `modus-operandi-larsen-palette' for user-defined entries.
...
`modus-operandi-larsen-palette-overrides')."
    :group 'modus-themes
  ...
  (defcustom modus-operandi-larsen-palette-overrides nil
    "Overrides for `modus-operandi-larsen-palette'.
...
represents."
  ...
  (modus-themes-theme modus-operandi-larsen
                      modus-operandi-larsen-palette
                      modus-operandi-larsen-palette-overrides)

  (provide-theme 'modus-operandi-larsen))

;;; modus-operandi-larsen-theme.el ends here
